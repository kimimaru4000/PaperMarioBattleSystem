...
namespace PaperMarioBattleSystem
{
    ...
    public class Main : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            BattleManager.Instance.Initialize(new BattleMario(new MarioStats(1, 50, 5, 0, 0, EquipmentGlobals.BootLevels.Normal, EquipmentGlobals.HammerLevels.Normal)), new Goombario(), new List<BattleEnemy>() { new Goomba(), new SpikedGoomba() });
