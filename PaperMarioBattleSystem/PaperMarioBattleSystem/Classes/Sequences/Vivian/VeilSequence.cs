...
namespace PaperMarioBattleSystem
{
    ...
    public sealed class VeilSequence : Sequence
    {
        ...
        private void OnUserTurnStart()
        {
            ...
            Debug.Log($"Starting second phase of {nameof(Veil)} for {EntityUsing.Name}!");
        ...
        {
            Debug.Log($"Skipped {AllyAffected.Name}'s turn for {nameof(Veil)} as it's being protected by {EntityUsing.Name}!");
