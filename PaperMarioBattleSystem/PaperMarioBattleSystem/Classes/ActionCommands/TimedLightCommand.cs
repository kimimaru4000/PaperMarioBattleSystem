...
namespace PaperMarioBattleSystem
{
    ...
    /// <para>The bar fills over time. As such, the values passed in should be time-based. Lights are spaced out evenly across the bar.</para>
    /// </summary>
    public class TimedLightCommand : FillBarCommand
    {
        ...
        /// </summary>
        protected double SpeedScale = 1f;
        ...
        public TimedLightCommand(IActionCommandHandler commandAction, double maxBarValue, int numLights, double lightRange, double speedScale) : base(commandAction, maxBarValue)
        {
            NumLights = numLights;
