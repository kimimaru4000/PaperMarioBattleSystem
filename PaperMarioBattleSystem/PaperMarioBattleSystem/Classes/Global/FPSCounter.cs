...
namespace PaperMarioBattleSystem
{
    ...
    public static class FPSCounter
    {
        ...
        {
            SpriteRenderer.Instance.DrawText(AssetManager.Instance.Font, $"{FPSValue}", Vector2.Zero, Color.White, .5f);
            if (Time.RunningSlowly == true)
            {
                SpriteRenderer.Instance.DrawText(AssetManager.Instance.Font, $"RUNNING SLOW!", new Vector2(0f, 20f), Color.Red, .5f);
            }
        }
    }
}
