        ...
        protected override void SequenceStartBranch()
        {
            ...
            switch (SequenceStep)
            {
                case 0:
                    ...
                    break;
                case 1:
                    CurSequenceAction = new MoveToSeqAction(User, User.BattlePosition - new Vector2(10, 0), 100d);
                    break;
                case 2:
                    CurSequenceAction = new MoveToSeqAction(User, User.BattlePosition, 100d);
                    break;
                case 3:
                    CurSequenceAction = new MoveToSeqAction(User, User.BattlePosition + new Vector2(10, 0), 100d);
                    break;
